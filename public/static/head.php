...
<link rel="shortcut icon" type="image/x-icon" href="<?=$static_repository?>img/favicon.ico">
<link rel="apple-touch-icon" sizes="152x152" href="<?=$static_repository?>img/apple-touch-icon-152x152.png" />

<link rel="preload" href="<?=$static_repository?>styles/fonts/VolvoBroadProDigital/VolvoBroadProDigital-webfont.woff" as="font" type="font/woff" crossorigin="anonymous">
